...
public class UbhShotCtrl : UbhMonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        if (m_startOnAwake)
        {
            ...
            {
                yield return StartCoroutine(UbhUtil.WaitForSeconds(m_startOnAwakeDelay));
            }
            StartShotRoutine();
        }
    }
    ...
    private IEnumerator ShotCoroutine()
    {
        ...
        while (true)
        {
            ...
            {
                yield return StartCoroutine(UbhUtil.WaitForSeconds(m_workShotInfoList[nowIndex].m_afterDelay));
            }
